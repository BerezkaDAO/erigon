...
type EthAPI interface {
	...
	GetBlockTransactions(ctx context.Context, number rpc.BlockNumber) ([]*RPCTransaction, error)
	GetManyBlockTransactions(ctx context.Context, from, to rpc.BlockNumber) ([]*RPCTransaction, error)
